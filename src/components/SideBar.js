...
class SideBar extends Component {
	...
	constructor(props){
		...
		for (let category in props.categories){
			initialState.categoriesChecked[category] = '';
		}
	    ...
	    return (
	    	<div className="sidebar">
	    		<nav className="navbar navbar-toggleable-md navbar-light bg-faded">
			    	<a className="navbar-brand" href="http://www.goodeggs.com" target="_blank"></a>
			  	</nav>
				<ul className="list-group">
				  ...
				  <li onClick={() => this.onCategoryClicked('meat')} className={"list-group-item product-category-item "  + this.state.categoriesChecked['meat']}><h3>Meats</h3></li>
